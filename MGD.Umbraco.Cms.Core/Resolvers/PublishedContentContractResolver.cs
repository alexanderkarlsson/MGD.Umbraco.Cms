...
namespace MGD.Umbraco.Cms.Core.Resolvers
{
    public class PublishedContentContractResolver : DefaultContractResolver
    {
        ...
        protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization memberSerialization)
        {
            ...
            property.ShouldSerialize = instance =>
            {
                ...
                if (property.PropertyName == "Variations") return false;
                if (property.PropertyName == "IsElement") return false;
                ...
                if (property.PropertyName == "ContentType") return true;
                if (property.PropertyName == "Url") return true;
                if (property.PropertyName == "ContentSet") return false;
